...
function aplicarIdioma() {
  ...
  document.querySelector("header h1")
    .textContent = t.titulo;

  document.querySelector("header p")
    .textContent = t.subtitulo;
  ...
  document.getElementById("leyenda-bar")
    .textContent = t.leyendas;

  document.querySelector("#destacados h2")
    .textContent = t.bienesServicios;

  document.querySelector(".btn-ver-todos")
    .textContent = t.verTodos;
